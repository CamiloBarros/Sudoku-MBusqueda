...
from primero_anchura.tablero import Tablero
...
""" 
    ...
    5. Creamos ramificaciones o estados con cada uno de los numeros y las añadimos a la cola
"""
...
def busqueda(tablero):
    ...
    while cola:
        ...
        """ 
                ...
                Celda = (0, 0)
                Posibles = [3, 4]
                Nodo inicial =  A   -> Nivel 0
                Extrae A  = [B(3), C(4)]
                Cola = []
                Cola = [B(3), C(4)]  -> Nivel 1

                Celda = (0, 2)
                Posibles = [3]
                Nodo Actual =  B
                Extrae B  = [D(3)]  -> Nivel 2
...
def resolver(tablero = None):
    ...
    tiempo_inicio = time()
    tablero_solucion, nNodos, iteraciones = busqueda(tablero_problema)
    tiempo_final = time()
